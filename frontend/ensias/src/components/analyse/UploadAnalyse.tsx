            ...
            <CardContent>
              <div className="flex items-center justify-center p-12 border-2 border-dashed rounded-lg">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-medium mb-1">Configurez une connexion API</h3>
                  <p className="text-sm text-muted-foreground">
                    Connectez-vous à des API REST ou GraphQL pour analyser les données
                  </p>
                  <Button className="mt-4">Configurer l'API</Button>
                </div>
              </div>
            </CardContent>
          </Card>
